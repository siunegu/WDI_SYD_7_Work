...
#	from (irb):16
#	from /Users/joel/.rvm/rubies/ruby-2.1.4/bin/irb:11:in `<main>'
...
# => [8, 4.0, 5.0, -1.0, 24, 3.5] 

number_array.push(value_integer_1)
# => [8, 4.0, 5.0, -1.0, 24, 3.5, 8]

number_array.unshift( Math.sqrt(36) )
# => [6.0, 8, 4.0, 5.0, -1.0, 24, 3.5, 8]
...
# => [6.0, 8, 4.0, 5.0, -1.0, 3.5, 8, [19, 21, 6, 3, 1]]
