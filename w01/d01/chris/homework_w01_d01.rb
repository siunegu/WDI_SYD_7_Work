...
message_array = [character_1, character_2] #["l", "h"]

message_array.push(character_2) #  ["l", "h", "h"]

message_array.pop() #"h"

message_array.push(character_3)#  ["l", "h", "c"]



message_array # => ["l", "h", "c"]

puts message_array #l
#h
#c
# => nil

print message_array #["l", "h", "c"] => nil
...
number_array.push(first_ans)#[4.0, 5.0, -1.0, 24, 16]

number_array.unshift(value_integer_1)#[8, 4.0, 5.0, -1.0, 24, 16]

number_array.push(value_integer_1)#[8, 4.0, 5.0, -1.0, 24, 16, 8]

number_array.unshift( Math.sqrt(36) )#[6.0, 8, 4.0, 5.0, -1.0, 24, 16, 8]

number_array.delete_at(5) #24



number_array.push( [19, 21, 6, 3, 1] )#[6.0, 8, 4.0, 5.0, -1.0, 16, 8, [19, 21, 6, 3, 1]]

number_array.flatten! #[6.0, 8, 4.0, 5.0, -1.0, 16, 8, 19, 21, 6, 3, 1]
