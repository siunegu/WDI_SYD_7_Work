...
def list_buildings(all_buildings)
  all_buildings.each do |single_building|
    # Getting apartment attribute within 'buildings' array, which is an object "building_one_apartments",
    # Map everything with condition 'single_apartment.is_available' to an array. 
