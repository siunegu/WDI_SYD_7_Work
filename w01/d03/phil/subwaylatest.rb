...
def determine_stops
  ...
  puts "You are at the same station, no need to travelc"  
  else
    if changes == 1
      print "It is #{num_stops} stops from #{origin_station[1]} on the #{origin_details[1]} to #{destination_station[1]} on the #{destination_details[1]}, with one change of train\n"
    elsif
      print "It is #{num_stops} stops from #{origin_station[1]} on the #{origin_details[1]} to #{destination_station[1]} on the #{destination_details[1]}."  
    end
  end
end 
